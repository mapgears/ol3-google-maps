...
function build(config, paths, callback) {
  ...
  if (!options.compile) {
    log.info('ol3-google-maps', 'No compile options found.  Concatenating ' +
...
function addHeader(compiledSource, callback) {
  exec('git describe --tags', function(error, stdout, stderr) {
    var header = '// Ol3-Google-Maps. See https://github.com/mapgears/ol3-google-maps/\n';
    header += '// License: https://github.com/mapgears/ol3-google-maps/blob/master/LICENSE\n';
    if (stdout !== '') {
